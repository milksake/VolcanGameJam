...
@export var displacement_amount : float = 0.5:
	set(v):
		displacement_amount = v
		_set_shader_param("displacement_amount", displacement_amount)

## Frequency of the vertex displacement
@export var displacement_frequency : float = 5.0:
	set(v):
		displacement_frequency = v
		_set_shader_param("displacement_frequency", displacement_frequency)
